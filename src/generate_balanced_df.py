...
columns_to_remove = ['Unnamed: 0','wh_fleg_leg_i','id_flight','carrier','season_trip','delay_minutes','scheduled_time_departure','year','previous_is_delayed','flights_within_hour']
...
print(Counter(y))
# define pipeline
over = SMOTENC(categorical_features=[0, 1, 3, 4,12], random_state=12345, sampling_strategy=0.4, n_jobs= -1)
