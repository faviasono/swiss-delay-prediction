...
def get_baseline_run(entity='andrea-faviait', project='swiss-delay-prediction', tag='baseline'):
...
def compare_runs(entity='andrea-faviait',
                 project='swiss-delay-prediction',
                 tag='baseline',
                 run_id=None):
